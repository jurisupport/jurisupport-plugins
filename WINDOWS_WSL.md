...
> 본 가이드는 **Windows에서 Linux 환경(WSL2)을 켜고 그 안에서 본 패키지를 쓰는 방법**입니다.
>
> WSL 설치 부담을 피하고 싶다면 **[WINDOWS_NATIVE.md](WINDOWS_NATIVE.md) (W1, 권장)** 를 먼저 검토하세요. winget으로 10분 안에 설치 가능하며, BIOS 가상화 활성화·재부팅이 불필요합니다.
>
> W2(WSL2)가 더 적합한 경우:
> - 평소 리눅스 환경에 익숙
> - 회사 보안프로그램이 윈도우 네이티브 설치를 강하게 막음
> - 사건폴더를 WSL Linux 파일시스템(`/home/<user>/사건`)에 두고 싶음
