...
- **`/songmu-legal:mock-hearing`** - 모의변론. 제출 전 서면·사건이론을 상대방 대리인·재판부 관점에서 공격해 약점을 드러내고, 구상 단계부터 법령·판결·교과서 근거 맵을 만든 뒤 강도 채점과 구조화된 평결(제출가능/보강/재구성/출구)·보강 과제를 낸다. 다중파일 구조(질문은행·채점루브릭·어조 규칙). brief-protocol 인용 검증 통과 후 선택 단계로 연계.
...
0.2.3 - mock-hearing 추가, 구상 단계 근거 정찰, §5 인덱스 보강
