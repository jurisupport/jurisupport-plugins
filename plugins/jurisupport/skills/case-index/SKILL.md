...
```bash
PY=/Users/$USER/.claude/plugins/cache/jurisupport-plugins/jurisupport/<플러그인버전>/skills/case-index/case_index.py
...
cp /Users/$USER/.claude/plugins/cache/jurisupport-plugins/jurisupport/<플러그인버전>/templates/_index.csv \
